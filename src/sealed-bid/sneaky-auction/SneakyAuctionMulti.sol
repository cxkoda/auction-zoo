...
contract SneakyAuction is ISneakyAuctionErrors, ReentrancyGuard {
    ...
    struct Auction {
        ...
        StructuredLinkedList.List bidValues;
        mapping(uint48 => Bid[]) bids;
        uint48 reservePrice;
        // =====================
    ...
    ///        being auctioned.
    // TODO tokenIdsHash explainers
    /// @param tokenIdsHash The ERC721 token ID of the asset being auctioned.
    /// @param seller The address selling the auctioned asset.
    ...
    ///         auctioned.
    mapping(address => mapping(bytes32 => Auction)) private auctions;
    ...
    function createAuction(
        ...
        Auction storage auction = auctions[tokenContract][tokenIdsHash];
        ...
        // TODO This can probably be done more efficiently by storing it in the
        // DLL
        auction.reservePrice = reservePrice;

        auction.collateralizationDeadlineBlockHash = bytes32(0);

        // TODO: Could require a lot of transfers. Think about way to lazyfy this.
    ...
    /// @param tokenContract The address of the ERC721 contract for the asset
    ///        that was auctioned.
    /// @param tokenIdsHash The ERC721 token ID of the asset that was auctioned.
    ...
    /// @param tokenContract The address of the ERC721 contract for the asset auctioned.
    /// @param tokenIdsHash The ERC721 token ID of the asset auctioned.
    /// @return seller The address of the seller.
    function getSeller(address tokenContract, bytes32 tokenIdsHash)
        external
        view
        returns (address seller)
    {
        return auctions[tokenContract][tokenIdsHash].seller;
    }

    /// @notice Gets the parameters and state of an auction in storage.
    /// @param tokenContract The address of the ERC721 contract for the asset auctioned.
    /// @param tokenIdsHash The ERC721 token ID of the asset auctioned.
    function getAuction(address tokenContract, bytes32 tokenIdsHash)
        external
        view
        returns (Auction memory auction)
    {
        return auctions[tokenContract][tokenIdsHash];
    }
